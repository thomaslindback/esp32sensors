...
#define MAX1704X_I2C_MASTER_SCL              CONFIG_I2C_MASTER_SCL      /*!< GPIO number used for I2C master clock */
#define MAX1704X_I2C_MASTER_SDA              CONFIG_I2C_MASTER_SDA      /*!< GPIO number used for I2C master data  */
#define MAX1704X_I2C_MASTER_NUM              0                          /*!< I2C master i2c port number, the number of i2c peripheral interfaces available will depend on the chip */
#define MAX1704X_I2C_MASTER_FREQ_HZ          100000                     /*!< I2C master clock frequency */
#define MAX1704X_I2C_MASTER_TX_BUF_DISABLE   0                          /*!< I2C master doesn't need buffer */
#define MAX1704X_I2C_MASTER_RX_BUF_DISABLE   0                          /*!< I2C master doesn't need buffer */
#define MAX1704X_I2C_MASTER_TIMEOUT_MS       1000
...
{
public:
  SFE_MAX1704X(sfe_max1704x_devices_e device = MAX1704X_MAX17048); // Default to the 5V MAX17048
  ...
  bool begin(uint8_t i2caddr = MAX1704x_ADDRESS, i2c_port_t master_port_num = I2C_NUM_0); //Returns true if module is detected
  ...
  // Output: 0 on success, positive integer on fail.
  esp_err_t write16(uint16_t data, uint8_t address);
...
private:
  ...
  int _device = MAX1704X_MAX17048; // Default to MAX17048
