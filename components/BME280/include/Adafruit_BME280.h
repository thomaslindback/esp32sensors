...
#define BME280_I2C_MASTER_SCL              CONFIG_I2C_MASTER_SCL      /*!< GPIO number used for I2C master clock */
#define BME280_I2C_MASTER_SDA              CONFIG_I2C_MASTER_SDA      /*!< GPIO number used for I2C master data  */
#define BME280_I2C_MASTER_NUM              0                          /*!< I2C master i2c port number, the number of i2c peripheral interfaces available will depend on the chip */
#define BME280_I2C_MASTER_FREQ_HZ          100000                     /*!< I2C master clock frequency */
#define BME280_I2C_MASTER_TX_BUF_DISABLE   0                          /*!< I2C master doesn't need buffer */
#define BME280_I2C_MASTER_RX_BUF_DISABLE   0                          /*!< I2C master doesn't need buffer */
  ...
  */
  ...
  class Adafruit_BME280 {
    ...
    */
    ...
    Adafruit_BME280();
    ~Adafruit_BME280();
    bool begin(uint8_t addr = BME280_ADDRESS, i2c_port_t master_port_num = I2C_NUM_0);
    bool init();
